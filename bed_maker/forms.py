...
from .models import  BedfileRequest, Profile, Transcript
...
class ManualUploadForm(forms.Form):
    ...
    requested_by = forms.EmailField()
    requested_for = forms.CharField()
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.helper.layout = Layout(
            ...
            Field('requested_for', placeholder="Enter the person's name who requested the bed file" ),
